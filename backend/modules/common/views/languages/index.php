...
//                                $code_img = Yii::$app->request->getHostInfo() . '/flags/' . $model->code . ".png";
                                $code_img = '/flags/' . $model->code . ".png";
                                return '<img src="' . $code_img . '"/> ' . $model->code;
                            }
                        ],
                        ...
                        [
                            ...
                            'value' => function ($model, $key, $index, $column) {
                                return ['1' => '是', '0' => '否'][$model->is_default];
                            },
                            'filter' => false
                        ],
