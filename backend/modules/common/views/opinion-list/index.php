                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                if (!empty($model->content) && mb_strlen($model->content) > 20) {
                                    return mb_substr($model->content, 0, 20, 'utf-8') . "..";
                                } else {
                        ...
                        [
                            ...
                            'filter' => false, //不显示搜索框
                            'value' => function ($model) {
                                if (!empty($model->img_list)) {
                                    return \common\helpers\ImageHelper::fancyBoxs(unserialize($model->img_list));
                                } else {
                                    return "(暂无)";
                                }
