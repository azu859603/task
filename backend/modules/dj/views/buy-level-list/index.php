            ...
            <div class="box-body table-responsive">
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'sellerLevel.translation.title',
//                            'filter' => Html::activeTextInput($searchModel, 'sellerLevel.translation.title', [
//                                    'class' => 'form-control',
//                                ]
//                            ),
                            'filter' => false,
                            'value' => function ($model) {
                                return $model->sellerLevel->translation->title;
                            }
                        ],
                        [
