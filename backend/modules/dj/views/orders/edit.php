        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="col-sm-12">
                    ...
                    <?= $form->field($model, 'seller_id', ['options' => ['class' => ['chart']]])->textInput() ?>
                    ...
                    <?= $form->field($model, 'private_key', ['options' => ['class' => ['chart']]])->textInput() ?>
                    <?= $form->field($model, 'key_status', ['options' => ['class' => ['chart']]])->textInput() ?>
