...
//                            'headerOptions' => ['width' => '216px'],
                        ...
                        [
                            ...
                            'attribute' => 'type',
                            'format' => 'raw',
                            'filter' => Html::activeDropDownList($searchModel, 'type', PromotionOrder::$typeExplain, [
                                    'prompt' => '全部',
                                    'class' => 'form-control'
                                ]
                            ),
                            'value' => function ($model) {
                                return PromotionOrder::$typeExplain[$model->type];
                            },
                        ],
                        ...
                        [
                            ...
                            'attribute' => 'status',
                            'format' => 'raw',
                            'filter' => Html::activeDropDownList($searchModel, 'status', PromotionOrder::$statusExplain, [
                                    'prompt' => '全部',
                                    'class' => 'form-control'
                                ]
                            ),
                            'value' => function ($model) {
                                return '<span class="label label-' . PromotionOrder::$statusColorExplain[$model->status] . '">' . PromotionOrder::$statusExplain[$model->status] . '</span>';
                            },
                        ],
