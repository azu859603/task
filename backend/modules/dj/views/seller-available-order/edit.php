...
/* @var $model common\models\dj\SellerAvailableOrder */
/* @var $form yii\widgets\ActiveForm */

$this->title = $model->isNewRecord ? '创建' : '编辑';
$this->params['breadcrumbs'][] = ['label' => 'Seller Available Orders', 'url' => ['index']];
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="col-sm-12">
                    ...
                    <?= $form->field($model, 'buy_number', ['options' => ['class' => ['chart']]])->textInput() ?>
