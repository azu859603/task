                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return \common\helpers\ImageHelper::fancyBox($model->translation->banner);
                            },
                            'format' => 'raw'
                        ],
                        'level',
                        ...
                        [
                            'class' => 'kartik\grid\EditableColumn',
                            'attribute' => 'return_income_time',
                        ],
                        [
                            'class' => 'kartik\grid\EditableColumn',
                            'attribute' => 'profit_rebate',
                        ],
                        [
                            'class' => 'kartik\grid\EditableColumn',
                            'attribute' => 'number',
                        ...
                        [
                            'class' => 'kartik\grid\EditableColumn',
                            'attribute' => 'handling_fees_percentage',
                        ],
                        [
                            'class' => '\kartik\grid\EditableColumn',
                            'editableOptions' => [
