...
/* @var $model common\models\dj\ShortPlaysList */
/* @var $form yii\widgets\ActiveForm */

$this->title = $model->isNewRecord ? '创建' : '编辑';
$this->params['breadcrumbs'][] = ['label' => 'Short Plays Lists', 'url' => ['index']];
                        ...
                        <div class="tab-content">
                            <div id=class="tab-pane">
                                <div class="panel-body">
                                    ...
                                    <?= $form->field($model_translations, 'synopsis', ['options' => ['class' => ['chart']]])->textarea() ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?= $form->field($model, 'amount', ['options' => ['class' => ['chart']]])->textInput() ?>
...
//                    $lang = Yii::$app->request->get('lang', $default_lang);
                    $lang = $default_lang;
                    $laberLists = \common\models\dj\LaberList::find()->with(['translation' => function ($query) use ($lang) {
                    ...
                    ?>
                    <?= $form->field($model, 'label', ['options' => ['class' => ['chart']]])->checkboxList($laberList) ?>
