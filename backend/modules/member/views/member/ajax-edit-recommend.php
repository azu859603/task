...
$this->title = '编辑';
$this->params['breadcrumbs'][] = ['label' => 'Withdraw Bills', 'url' => ['index']];
...
JS;
                    ?>
                    <?= $form->field($model, 'id',['options' => ['class' => 'form-group c-md-5']])->widget(\kartik\widgets\Select2::classname(), [
                        'options' => ['placeholder' => '请选择下线'],
                        'pluginOptions' => [
                            'allowClear' => true,
                            'ajax' => [
                                'url' => "get-user",
