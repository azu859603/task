    ...
    <div class="modal-body">
        ...
        <div class="col-md-12">
            <div class="col-sm-6 invoice-col">
                <p class="lead"></p>
                <address class="p-m">
                    <img src="<?= ImageHelper::defaultHeaderPortrait($model->head_portrait) ?>"
                         class="img-circle img-bordered-sm" width="48" height="48">
                </address>
            </div>
            <div class="col-sm-6 invoice-col">
                <address>
                    ID: <?= $model['id'] ?><br>
                    账号: <?= Html::encode($model['mobile']) ?><br>
                    昵称: <?= Html::encode($model['nickname']) ?>
                </address>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-3" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <?= $form->field($rechargeForm, 'old_num')->textInput([
                                    'value' => $model['account']['experience'],
                                    'readonly' => 'readonly'
                                ]) ?>
                                <?= $form->field($rechargeForm, 'change')->radioList(RechargeForm::$changeExplain) ?>
                                <?= $form->field($rechargeForm, 'experience')->textInput() ?>
                                <?= $form->field($rechargeForm,
                                    'type')->hiddenInput(['value' => RechargeForm::TYPE_EXPERIENCE])->label(false) ?>
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        <button class="btn btn-primary" type="submit">确认</button>
                                    </div>
                        ...
                        <div id="tab-4" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <?= $form->field($rechargeForm, 'old_num')->textInput([
                                    'value' => $model['account']['can_withdraw_money'],
                                    'readonly' => 'readonly'
                                ]) ?>
                                <?= $form->field($rechargeForm, 'change')->radioList(RechargeForm::$changeExplain) ?>
                                <?= $form->field($rechargeForm, 'money')->textInput() ?>
                                <?= $form->field($rechargeForm, 'remark')->textarea() ?>
                                <?= $form->field($rechargeForm,
                                    'type')->hiddenInput(['value' => RechargeForm::TYPE_CAN_WITHDRAW_MONEY])->label(false) ?>
                                <div class="box-footer">
                                    <div class="col-sm-12 text-center">
                                        <button class="btn btn-primary" type="submit">确认</button>
                                    </div>
