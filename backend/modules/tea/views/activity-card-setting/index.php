...
$this->title = '卡片管理=》温馨提示：所有收集卡中奖概率加一起等于一百';
...
//                            'filter' => Html::activeDropDownList($searchModel, 'activity.title', $activity_lists, [
//                                'prompt' => '全部',
//                                'class' => 'form-control'
//                            ]),
//                            'value' => function ($model, $key, $index, $column) {
//                                return $activity_lists[$model->pid];
//                            },
//
//                        ],
                        [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return \common\helpers\ImageHelper::fancyBox($model->banner1);
                            },
                            'format' => 'raw'
                        ],
                        [
                            ...
                            'filter' => false, //不显示搜索框
                            'value' => function ($model) {
                                return \common\helpers\ImageHelper::fancyBox($model->banner2);
                            },
                            'format' => 'raw'
                        ],
                        [
                            ...
                            'editableOptions' => [
                                ...
                                'data' => \common\models\tea\ActivityCardSetting::$typeExplain,
                                'formOptions' => [
                                    'action' => ['index']
                                ]
                            ],
                            'attribute' => 'type',
                            'value' => function ($model, $key, $index, $column) {
                                return \common\models\tea\ActivityCardSetting::$typeExplain[$model->type];
                            },
                            'filter' => Html::activeDropDownList($searchModel, 'type', \common\models\tea\ActivityCardSetting::$typeExplain, [
                                'prompt' => '全部',
                                'class' => 'form-control'
                            ])
                        ],
                        ...
                        [
                            ...
                            'filter' => Html::activeDropDownList($searchModel, 'manager.username', $managers, [
                                    'prompt' => '全部',
                                    'class' => 'form-control'
                                ]
                            ),
