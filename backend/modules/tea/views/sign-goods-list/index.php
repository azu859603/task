                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'type',
                            'format' => 'raw',
                            'filter' => Html::activeDropDownList($searchModel, 'type', \common\models\tea\SignGoodsList::$typeExplain, [
                                    'prompt' => '全部',
                                    'class' => 'form-control'
                                ]
                            ),
                            'value' => function ($model) {
                                return \common\models\tea\SignGoodsList::$typeExplain[$model->type];
                            },
