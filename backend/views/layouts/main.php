...
<?php $this->beginPage() ?>
    ...
    <!-- 加载文件排序消除报错 -->
    <?php
    $backendAppAsset = array();
    $backendAppAsset['backend\assets\AppAsset'] = Yii::$app->view->assetBundles['backend\assets\AppAsset'];
    unset(Yii::$app->view->assetBundles['backend\assets\AppAsset']);
    $assetBundlesArray = array_merge($backendAppAsset, Yii::$app->view->assetBundles);
    Yii::$app->view->assetBundles = $assetBundlesArray;
    ?>
