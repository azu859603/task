...
//        $gateway->setAlipayPublicKey(Yii::getAlias($this->config['ali_public_key']));
        $gateway->setAlipayPublicKey(CommonPluginHelper::getPublicKey($this->config['ali_public_key']));
//        $gateway->setPrivateKey(Yii::getAlias($this->config['private_key']));
        $gateway->setPrivateKey(CommonPluginHelper::getPrivateKey($this->config['private_key']));
