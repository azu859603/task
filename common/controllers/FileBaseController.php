...
class FileBaseController extends Controller
{
    ...
    {
        $upload_drive = Yii::$app->debris->config('backend_upload_drive');
        $request = Yii::$app->request->post();
        $request['drive'] = $upload_drive;
        try {
            $upload = new UploadHelper($request, Attachment::UPLOAD_TYPE_FILES);
            $upload->verifyFile();
            $upload->save();
    ...
    public function actionVideos()
    {
        ...
        $request['drive'] = $upload_drive;
        try {
            $upload = new UploadHelper($request, Attachment::UPLOAD_TYPE_VIDEOS);
            $upload->verifyFile();
            $upload->save();
    ...
    public function actionVoices()
    {
        ...
        $request['drive'] = $upload_drive;
        try {
            $upload = new UploadHelper($request, Attachment::UPLOAD_TYPE_VOICES);
            $upload->verifyFile();
            $upload->save();
