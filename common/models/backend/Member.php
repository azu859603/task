 ...
 * @property string $last_session 最后一次登陆session
 * @property int online_status
 * @property string $room_ids 关联房间id，逗号分隔
 * @property string $nickname
 * @property string $google_secret
 * @property int $google_switch
 */
class Member extends User
{
    ...
    {
        return [
            [['type', 'gender', 'province_id', 'city_id', 'area_id', 'visit_count', 'last_time', 'role', 'status', 'created_at', 'updated_at','online_status','google_switch'], 'integer'],
            [['birthday','room_ids'], 'safe'],
            ...
            [['last_session','nickname','google_secret'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'created_at' => '创建时间',
            'updated_at' => '修改时间',
            'last_session' => '最后一次登陆session',
            'online_status' => '在线状态',
            'room_ids' => '关联房间',
            'nickname' => '昵称',
            'google_switch' => '谷歌验证开关',
    ...
    {
        return $this->hasOne(\common\models\member\Member::class, ['b_id' => 'id']);
    }
}
