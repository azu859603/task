...
/**
 * This is the model class for table "base_notify".
 *
...
class Notify extends \common\models\base\BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['content'], 'string'],
            [['type', 'target_id', 'target_display', 'view', 'sender_id', 'sender_display', 'sender_withdraw', 'status', 'updated_at'], 'integer'],
    ...
    {
        return $this->hasMany(NotifyMember::class, ['notify_id' => 'id'])->with('member');
    }
