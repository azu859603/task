...
<div class="modal-body">
    <div class="row">
        <div class="col-lg-2">
        <?= Html::dropDownList('type', '', ArrayHelper::merge(['' => '不限上传类型'], [1 => "后台上传", 2 => "用户上传"]), [
            'class' => 'form-control',
            'id' => 'rfType',
        ]) ?>
        </div>
...
<script type="text/html" id="rfAttachmentlistModel">
    ...
    <li>
        <div class="border-color-gray {{value.id}}" data-id="{{value.id}}" data-name="{{value.name}}"
             data-url="{{value.base_url}}" data-upload_type="{{value.upload_type}}">
            ...
            <div class="mailbox-attachment-info">
                ...
                {{value.size}}
                <a href="{{value.base_url}}" target="_blank" class="btn btn-white btn-xs pull-right"><i
